...
use crate::camera::camera_structure::MainCamera;
use crate::mouse::mouse_events::MyCursorMoved;

pub fn main_camera_update(
    mouse_button_input: Res<Input<MouseButton>>, //enum vs event- EventReader<MouseButtonInput>,
    mut mouse_wheel_ev: EventReader<MouseWheel>,
    mut cursor: EventReader<MyCursorMoved>,
    time: Res<Time>,
